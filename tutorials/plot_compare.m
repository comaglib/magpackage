...
% figure;
% subplot(2,1,1);
% plot(info_bdf_1e2.times,info_bdf_1e2.CurrentHistory);
% hold on;
% plot(info_bdf_1e3.times,info_bdf_1e3.CurrentHistory);
% hold on;
% plot(info_bdf_5e4.times,info_bdf_5e4.CurrentHistory);
% legend('step-1e4-tol-1e2','step-1e3-tol-1e3','step-1e3-tol-5e4');
% grid on;
% subplot(2,1,2);
% plot(info_bdf_1e2.times,info_bdf_1e2.ProbeB_History);
% hold on;
% plot(info_bdf_1e3.times,info_bdf_1e3.ProbeB_History);
% hold on;
% plot(info_bdf_5e4.times,info_bdf_5e4.ProbeB_History);
% legend('step-1e4-tol-1e2','step-1e3-tol-1e3','step-1e3-tol-5e4');
% grid on;
% subplot(2,1,1);
% xlabel('Time (s)'); ylabel('Current (A)');
...
plot(info_bdf_5e4.times,info_bdf_5e4.CurrentHistory);
grid on;
legend('info bdf 1e3','info bdf 5e4');
