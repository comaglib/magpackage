...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    // 11: Qw, 12: CurlRef
    // 13-19: Material Data (8 arrays)
    // 20: RequestJacobian
    // 21: Scalings
    
    if (nrhs < 22) mexErrMsgIdAndTxt("MagPackage:HBFEM", "Need 22 inputs (Split Complex).");
    ...
    bool requestJ = (bool)mxGetScalar(prhs[20]);
    double *Scalings = mxGetPr(prhs[21]);
